    ...
    private final ViewPager.OnPageChangeListener mInternalPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (mLastPosition >= 0 && (currentIndicator = getChildAt(mLastPosition)) != null) {
                ...
                LayoutParams lp = (LayoutParams) currentIndicator.getLayoutParams();
//                lp.leftMargin = mIndicatorMargin;
//                lp.rightMargin = mIndicatorMargin;
//                currentIndicator.setLayoutParams(lp);
//                currentIndicator.invalidate();
            ...
            if (selectedIndicator != null) {
                ...
                LayoutParams lp = (LayoutParams) selectedIndicator.getLayoutParams();
//                if (position == 0) {
//                    lp.leftMargin = mIndicatorMargin;
//                    lp.rightMargin = mIndicatorMargin + mIndicatorMargin / 2;
//                } else if (position == 1) {
//                    lp.leftMargin = mIndicatorMargin;
//                    lp.rightMargin = mIndicatorMargin;
//                } else if (position == 2) {
//                    lp.leftMargin = mIndicatorMargin + mIndicatorMargin / 2;
//                    lp.rightMargin = mIndicatorMargin;
//                }
